            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div className="col-span-1 md:col-span-2">
                    <a href="#" className="inline-flex flex-col items-start gap-0 mb-6 group">
                        ...
                        <p className="text-2xl font-bold m-0 leading-none text-white">M<span className="text-violet-500">B</span></p>
                    </a>
                    <p className="text-slate-400 text-lg max-w-sm leading-relaxed mb-6">
                        Tworzę nowoczesne rozwiązania cyfrowe, które pomagają markom wyróżnić się w sieci. Od stron wizytówek po zaawansowane aplikacje webowe.
                    </p>
                    <div className="flex gap-4">
                        <a href="#" className="w-10 h-10 flex items-center justify-center rounded-xl bg-violet-500/5 border border-violet-500/20 text-slate-400 hover:text-white hover:border-violet-500/50 hover:bg-violet-500/10 transition-all duration-300">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li><Link href="#" className="text-slate-400 hover:text-violet-500 transition-colors">Usługi</Link></li>
                        <li><Link href="#" className="text-slate-400 hover:text-violet-500 transition-colors">Portfolio</Link></li>
                        <li><Link href="#" className="text-slate-400 hover:text-violet-500 transition-colors">O mnie</Link></li>
                        <li><Link href="#" className="text-slate-400 hover:text-violet-500 transition-colors">Kontakt</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        <li className="flex items-start gap-3">
                            <svg className="w-5 h-5 text-violet-500 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            <span className="text-slate-400">kontakt@michalbertman.pl</span>
                        </li>
                        <li className="flex items-start gap-3">
                            ...
                            <span className="text-slate-400">Polska, Zdalnie</span>
                        </li>
                    </ul>
                </div>
            </div>
